...
```mermaid
flowchart LR
  G0["G0 spec 三件套齐备 ✅"] --> R15["R1–R5 清零 ✅ af20d85"] --> UT["629 离线单测全绿 ✅ 2026-09-07"]
...
flowchart LR
  ...
  B312_OLD --> B312_NOW["T312 审计与红利税/拆股加权修复<br/>629 passed ⏵当前基线"]
  ...
  style B312_NOW fill:#dcfce7,stroke:#16a34a,color:#0f172a
```
