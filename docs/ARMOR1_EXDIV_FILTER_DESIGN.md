...
**测算的诚实边界**：+0.3pp/年 是**上限估计**（H1 取 100%）。若真实惩罚档占比为 40%（月度调仓下大部分建仓持股期超 1 个月，`T312_FINAL_SUMMARY.md` §4.1 实测年化换手 332.39% ⇒ 平均持股约 1 个月以上），则年化改善约 **+0.12pp/年**，10 年复利约 **+1.2pp**。
...
2. 修正后立项动机为『S-4 事前化的确定性收益』，本质是『少亏钱』而非『多赚钱』，
   与方案 D 主线宽度择时（MDD 21.75% / CAGR +3.96%）相比边际价值过低。
