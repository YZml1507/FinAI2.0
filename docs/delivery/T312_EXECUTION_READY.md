...
| 指标 | 目标 | 对比基准（Momentum） | ⛔ 2026-09-10 实测（产物真值） |
|---|---|---|---|
| **胜率** | ≥35% | 0%（T304，⛔ 无落盘产物） | **28.21% ⇒ 未达标** |
| **最大回撤** | <35% | 68% (crash)（⛔ 无落盘产物） | **43.08% ⇒ 未达标（`G-MDD-1` FAIL）** |
| **年化换手** | <400% | 1271% (crash)（⛔ 无落盘产物） | 201.14% ⇒ 达标 |

⛔ **原文三行前的「✅」为误标**：它们本是**目标值**而非已达成结论；实测 3 条中 **2 条未达标**，已按权威产物更正。

**加分项**（满足 ≥1 条）：⛔ 实测总收益 **−27.72%**、夏普 **−0.379**；原文基准（vs −68% crash / −13）中的动量侧数字**无落盘产物**，不可比。

---

## 预期结果（参考范围）

⛔ **本节全部为「执行前预期」，均已被实测推翻，不得引为结论**（实测：CAGR **−3.20%**、夏普 **−0.379**、MDD **43.08%**、换手 **201.14%**、胜率 **28.21%**）：

| 指标 | 预期范围（原） | 信心度 | ⛔ 实测 |
|---|---|---|---|
| CAGR | 5-8% | 中 | −3.20% |
| 夏普比率 | 0.5-0.8 | 中 | −0.379 |
| 最大回撤 | 25-35% | 高 | 43.08%（超上限） |
| 年化换手 | 200-400% | 高 | 201.14% |
| 胜率 | 35-50% | 中 | 28.21% |
| 红利税占比 | 10-20% | 高 |
