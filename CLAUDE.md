...
- 📊 **幸存者偏差实测口径（2026-09-20）**：e22b 数据面补采取消——C3 管线已含退市票（缺口=0）；去偏参照=c3-p1-yearly（同参同日历）：ΔCAGR+0.66pp/ΔMDD+7.80pp；对外口径「CAGR 8.6–9.2%/MDD 17–25%（池依赖）」，详见 FINAL_DELIVERY §十。
